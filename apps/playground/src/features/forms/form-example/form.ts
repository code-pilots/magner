...
export default cardPageController<BigTestEntity>({
  header: {
    title: translate('form_example.form.title'),
    ...
    actions: [
      {
        ...
        emits: 'cancel',
        props: {
          text: translate('form_example.form.cancel_button'),
        },
      },
      {
        type: 'action',
        ...
        props: {
          type: 'primary',
          text: translate('form_example.form.submit_button'),
        },
      },
      {
        type: 'action',
        ...
        props: {
          type: 'danger',
          text: translate('form_example.form.remove_button'),
        },
      },
      {
        type: 'action',
        ...
        emits: 'clear',
        props: {
          text: translate('form_example.form.clear_button'),
        },
      },
    ],
          ...
          fields: [
            {
              ...
              props: {
                id: 'editor1',
                placeholder: 'Start writing the text',
              },
            },
          ],
        },
